    ...
    <>
      ...
      <div id="profile-upper">
        <div id="profile-banner-image">
          <img
            src="images/Food_and_beverages_sector/All_That_Dips/pic2_atd.png"
            alt="Banner image"
          />
        </div>
        <div id="profile-d">
      ...
      <div className="box-new">
        <p className="box-to-pad">
          Provides unique dips that are gluten free, have no MSG, no
          preservatives and have the unique combinations of great flavours from
          across the globe
        </p>
        <br></br>
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <div className="socials">
              <a
                href="https://www.facebook.com/BechefbyAllThatDips/ "
                class="fa fa-facebook"
              ></a>
              <a
                href="https://twitter.com/allthatdips?lang=en "
                class="fa fa-twitter"
              ></a>
              <a
                href="https://in.linkedin.com/company/all-that-dips"
                class="fa fa-linkedin"
              ></a>
            </div>

            <p>
              <a href="https://www.allthatdips.com/">allthatdips.com</a>
            </p>
