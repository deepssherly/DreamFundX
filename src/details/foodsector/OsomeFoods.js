    ...
    <>
      ...
      <div id="profile-upper">
        <div id="profile-banner-image">
          <img
            src="images/Food_and_beverages_sector/Osome_Foods/pic4_osm.png"
            alt="Banner image"
          />
        </div>
        <div id="profile-d">
      ...
      <div className="box-new">
        <p>
          Osome provide alternative healthy snacking option for modern
          lifestyle.We follow basic and traditional process so that we can be
          sure that everything we make should be nearest to mother nature.
        </p>
        <br></br>
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <div className="socials">
              <a
                href="https://www.instagram.com/osome.foods/"
                class="fa fa-facebook"
              ></a>
              <a
                href="https://twitter.com/Osome83465970"
                class="fa fa-twitter"
              ></a>
              <a
                href="https://in.linkedin.com/company/osomefoods"
                class="fa fa-linkedin"
              ></a>
            </div>

            <p>
              <a href="http://osome.in/">osome.in</a>
            </p>
