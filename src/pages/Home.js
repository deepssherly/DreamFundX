    ...
    <>
      ...
      <section className="section-2">
        <div className="col-new span-1-of-7 col-new-box-1">
            <img src="images/images2/number-line-orange2.png" className="number-line" alt="bg1"/>
        </div>
        <div className="col-new span-2-of-7 col-new-box-2">
            <div className="box-new-1">
                ...
                <hr/>
                <hr/>
                <p>start by signing up for an account here.<br></br>
                    All you need is to sign up,<br></br>
                    upload your documents and you are ready to start!</p>
            </div>
            <div className="box-new-2">
                <h3>Start Investing</h3>
                <p>Once your account is approved,<br></br>
            ...
            <div className="box-new-2">
                ...
                <p>You can easily monitor investments via your dashboard<br></br>
                    This is also where you can do that funds transfer in or out of your account</p>
            </div>
        ...
        <div className="col-new span-3-of-7 col-new-box-3">
            <img src="images/images2/Numberline2 (2).png" className="tree" alt="bg1"/>
